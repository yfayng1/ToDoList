...
class ToDosControllerTest < ActionController::TestCase
  ...
  test "should create to_do" do
    assert_difference('ToDo.count') do
      post :create, to_do: { due_date: @to_do.due_date, due_time: @to_do.due_time, priority: @to_do.priority, task: @to_do.task }
    end
  ...
  test "should update to_do" do
    patch :update, id: @to_do, to_do: { due_date: @to_do.due_date, due_time: @to_do.due_time, priority: @to_do.priority, task: @to_do.task }
    assert_redirected_to to_do_path(assigns(:to_do))
  end
